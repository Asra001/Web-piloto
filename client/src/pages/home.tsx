 ...
 */
const heroImage =
  "https://d2xsxph8kpxj0f.cloudfront.net/310519663653120528/Un3gtEeM9mTc77nFkDXjig/soluciones-hero-workbench-SHjYrN75kZmtwHu7iF9XmY.webp";
const perfilImage =
  "/yo_reparando.jpg";
const abstractImage =
  "https://d2xsxph8kpxj0f.cloudfront.net/310519663653120528/Un3gtEeM9mTc77nFkDXjig/diagnostic-flow-abstract-f4TqdZWEu7RLwgDrLhcMXk.webp";
const contactImage =
  "https://d2xsxph8kpxj0f.cloudfront.net/310519663653120528/Un3gtEeM9mTc77nFkDXjig/contact-workshop-calm-7pzfBNzPgZ3kS6YQwtH3n2.webp";
...
const galleryItems: GalleryItem[] = [
  ...
  {
  id: 2,
  title: "Mantenimiento PS4 Slim",
  category: "Sony",
  type: "image",
  image: "/IMG_0513.jpg",
  problem: "PS4 Slim con 7 años sin abrir. Acumulación severa de polvo en ventilador y disipador, pasta térmica original completamente degradada.",
  solution: "Desmontaje completo, limpieza exhaustiva de todos los componentes internos y sustitución de pasta térmica. Consola revisada y funcionando correctamente",
  videoUrl: "https://www.facebook.com/share/v/1CeJEzfbdh/"
},
];
...
const services = [
  {
    ...
    description:
      "Diagnóstico y reparación de fallos frecuentes en consolas: limpieza, mantenimiento preventivo, conectores, ventilación y problemas de encendido.",
  },
  {
    icon: Wrench,
    title: "Mandos y periféricos",
    description:
      "Sustitución y revisión de joysticks, botones, gatillos, baterías, conectores y piezas sometidas a desgaste por uso intensivo.",
  },
  {
    icon: MonitorCog,
    title: "Soporte informático",
    description:
      "Configuración, optimización, resolución de incidencias y acompañamiento técnico para usuarios particulares o pequeños entornos profesionales.",
  },
];
...
function handleNext() {
  ...
  function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    emailjs
  .send("service_wcrn1ld", "template_zh9am56", templateParams, "x0bOKMspMwZdEpQc-")
  .then(() => {
    //Auto-reply
    return emailjs.send(
      "service_wcrn1ld",
  ...
  return (
    <div className="min-h-screen bg-[#f3efe5] text-[#1f2d28] selection:bg-[#53847A] selection:text-white">
        ...
        <nav className="container flex h-20 items-center justify-between gap-5">
          <a href="#inicio" className="group flex items-center gap-3" aria-label="Ir al inicio">
            <img
              src={perfilImage}
              alt="Logo de perfil"
              className="h-11 w-11 rounded-sm border border-[#53847A]/30 object-cover shadow-sm transition-transform duration-300 group-hover:-translate-y-0.5"
            />
      ...
      <main id="inicio" className="overflow-hidden pt-20">
        <section className="relative min-h-[calc(100vh-5rem)] border-b border-[#d9cdb7]">
          <div className="absolute inset-0">
            <img
              src={heroImage}
              alt="Mesa de reparación electrónica con mando abierto, herramientas de precisión y portátil de diagnóstico"
          ...
          <div className="container relative flex min-h-[calc(100vh-5rem)] items-center py-16">
            <div className="max-w-3xl animate-rise text-white">
              ...
              <h1 className="font-display text-5xl font-semibold leading-[0.95] tracking-tight sm:text-6xl lg:text-7xl">
                Reparación de hardware y consolas con precisión.
              </h1>
        ...
        <section id="sobre-mi" className="container grid gap-12 py-24 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          <div className="relative">
            ...
            <img
              src={perfilImage}
              alt="Perfil profesional: técnico trabajando en reparación de equipos informáticos"
              className="relative aspect-[4/5] w-full max-w-lg object-cover shadow-[0_30px_80px_rgba(44,58,50,0.25)]"
            />
          ...
          <div>
            ...
            <h2 className="mt-4 font-display text-4xl font-semibold tracking-tight text-[#20332c] sm:text-5xl">
              Un perfil técnico en software y reparación de hardware.
            </h2>
            <p className="mt-7 text-lg leading-8 text-[#526158]">
              Mi objetivo es ofrecer un servicio cercano, útil y transparente, centrado en la informática aplicada, la resolución de problemas y la reparación y restauración de consolas y mandos.
              Este portfolio está orientado a generar confianza en clientes y demostrar a reclutadores criterio técnico, constancia y capacidad de aprendizaje.
            </p>
            <div className="mt-8 grid gap-3 sm:grid-cols-2">
              {skills.map((skill) => (
                <div key={skill} className="flex items-center gap-3 border border-[#d7c8ad] bg-white/45 px-4 py-3 text-sm text-[#31443d]">
        ...
        <section id="galeria" className="container py-24">
          ...
          <div className="grid gap-6 lg:grid-cols-3">
            {filteredItems.map((item) => (
              <div
                key={item.id}
                className="group cursor-pointer overflow-hidden border border-[#d7c8ad] bg-white transition-all duration-300 hover:shadow-lg hover:-translate-y-1"
                onClick={() => {
        ...
        {selectedIndex !== null && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#1f2d28]/80 p-4 backdrop-blur-sm">
            <div className="relative max-h-[90vh] w-full max-w-3xl overflow-hidden bg-white shadow-2xl">
              <button
                onClick={() => setSelectedIndex(null)}
                className="absolute right-4 top-4 z-10 rounded-full bg-[#53847A] p-2 text-white transition-transform duration-200 hover:scale-110"
              >
                <X className="h-5 w-5" />
              </button>
                ...
                <div className="relative bg-[#f0e8d8] overflow-hidden">
                  <div className="grid grid-cols-2 gap-4 p-4 h-full">
                    {filteredItems[selectedIndex]?.image && (
                      <div className="relative aspect-square overflow-hidden border border-[#d7c8ad]">
                        <img
                          src={filteredItems[selectedIndex].image}
                          alt={filteredItems[selectedIndex].title}
                          className="h-full w-full object-cover cursor-zoom-in"
                          onClick={() =>
                            window.open(filteredItems[selectedIndex].image, "_blank")
                          }
                        />
                      </div>
  
                    )}
                    {filteredItems[selectedIndex]?.videoUrl && (
                      <div className="relative aspect-square overflow-hidden border border-[#d7c8ad] bg-[#20332c] flex items-center justify-center">
                        <a
                          href={filteredItems[selectedIndex].videoUrl}
                          target="_blank"
                ...
                <div className="flex flex-col justify-between p-6 sm:p-8">
                  <div>
                    ...
                    <div className="mt-6 space-y-4">
                      <div>
                        ...
                        <p className="mt-2 text-[#31443d]">{filteredItems[selectedIndex]?.problem}</p>
                      </div>
                      <div>
                        <p className="font-mono text-xs font-semibold uppercase tracking-[0.16em] text-[#53847A]">
                          Solución
                        </p>
                        <p className="mt-2 text-[#31443d]">{filteredItems[selectedIndex]?.solution}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mt-8 flex gap-3">
                    <button
                      ...
                      className="flex items-center justify-center gap-2 border border-[#d7c8ad] bg-white px-4 py-2 text-sm font-semibold text-[#20332c] transition-all duration-200 hover:bg-[#f7f1e6]"
                    >
        ...
        <section id="proceso" className="container grid gap-12 py-24 lg:grid-cols-[1fr_0.85fr] lg:items-start">
          ...
          <div className="space-y-4">
            {workflow.map((item, index) => (
              <div key={item} className="group flex gap-5 border border-[#d7c8ad] bg-[#fffaf0]/70 p-5 transition duration-300 hover:-translate-y-1 hover:bg-white">
        ...
        <section className="container pb-24">
          <div className="grid overflow-hidden border border-[#d7c8ad] bg-[#f7f1e6] lg:grid-cols-[0.9fr_1.1fr]">
            ...
            <div id="contacto" className="flex flex-col justify-center p-8 sm:p-10 lg:p-16">
              <p className="section-kicker">Contacto</p>
              <h2 className="mt-4 font-display text-4xl font-semibold tracking-tight text-[#20332c]">
                Reparaciones o propuestas profesionales.
              </h2>
              <form onSubmit={handleSubmit} className="mt-8 grid gap-4">
                ...
                <label className="form-label">
                  ...
                  <input name="company" style={{ display: "none" }} autoComplete="off" tabIndex={-1}/>
                </label>
                <Button type="submit" size="lg" disabled={loading} className="bg-[#53847A] text-white hover:bg-[#446e65] border border-[#53847A]">
        ...
        <div className="container flex flex-col gap-8">
          ...
          <div className="border-t border-[#d9cdb7] pt-6">
            ...
            <div className="flex gap-4">
              <a
                href="https://www.facebook.com/profile.php?id=61572463093752&sk=reels_tab"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-[#d8c59f] text-[#d8c59f] transition-all duration-300 hover:bg-[#53847A] hover:border-[#53847A] hover:text-white"
                aria-label="Facebook"
              >
                <FaFacebook className="h-5 w-5" />
              </a>
              <a
                href="https://www.instagram.com/soluciones_it_rapidas_hayden/"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-[#d8c59f] text-[#d8c59f] transition-all duration-300 hover:bg-[#53847A] hover:border-[#53847A] hover:text-white"
              ...
              <a
                href="https://www.linkedin.com/in/hayden-aguilera-vico-it"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-[#d8c59f] text-[#d8c59f] transition-all duration-300 hover:bg-[#53847A] hover:border-[#53847A] hover:text-white"
                aria-label="LinkedIn"
